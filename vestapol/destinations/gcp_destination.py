...
class GoogleCloudPlatform(base_destination.BaseDestination):
    def __init__(self, gcs_bucket_name=None, gcs_root_prefix=None, gbq_project_id=None, gbq_dataset_id=None, gbq_dataset_location=None):
        ...
        self.gbq_dataset_location = gbq_dataset_location or os.environ['GBQ_DATASET_LOCATION']
    ...
    def create_table(self, resource):
        ...
        sources = [
            f'{common_prefix}/*/{resource.response_filename}'
        ]

        source_uris = [
            f'{self.gcs_root_prefix_fq}{source}' for source in sources
        ]
        ...
        external_tables.create_gcp_table(resource.external_data_format_tag, self.gbq_project_id, self.gbq_dataset_id,
                                         self.gbq_dataset_location, tablename, source_uri_prefix_fq,
                                         source_uris
                                         )
